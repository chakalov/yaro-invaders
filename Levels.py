...
class Levels:
	...
	def loadLevel(self, data):
		...
		for location in self.locations:
			self.allEnemies.add(Ships.BaseShip.BaseShip("images/invader2.png", 50, location, 1.5, Ships.Weapons.BaseWeapon.BaseWeapon((25, -25), 1, 3000, Ships.Weapons.Bullets.AlienBomb.AlienBomb)))
